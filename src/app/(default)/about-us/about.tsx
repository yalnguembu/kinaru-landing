...
import {
  makeToLeftVariant,
  makeToUpVariant,
} from "@/constants/variants.motion";
...
export default function AboutContent() {
  return (
    <div id="about" className="flex flex-col gap-10 my-10 overflow-hidden">
      ...
      <section>
        <div className="flex flex-col gap-5 text-center px-10">
          ...
          <motion.p
            ...
            variants={makeToUpVariant({ delay: 0.25 })}
            initial="hidden"
            whileInView="visible"
          >
            Kinaru est une application innovante dédiée à la gestion de
            locations immobilières. Elle permet aux utilisateurs de rechercher
            des propriétés à louer et aux propriétaires de suivre la gestion de
            leurs bien en toute simplicité.
          </motion.p>
        </div>
      </section>
      ...
      {/* COMPANY STATS */}
      <motion.div
        variants={makeToLeftVariant({ delay: 0.2 })}
        initial="hidden"
        whileInView="visible"
      >
        <CompanyStatsSection />
