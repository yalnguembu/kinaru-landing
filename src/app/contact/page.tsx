      ...
      <div className="container flex flex-col gap-20">
        <section>
            <div className="text-center flex flex-col gap-3 justify-center items-center">
              ...
              <p className="max-w-[500px]">Lorem Ipsum is simply dummy text of the printing indus orem Ipsum has been the industrys standard dummy text ever since.</p>
            </div>
        ...
        <ContactForm />
          {/* MAP SECTION */}
        <section>
            <div className="container rounded-xl overflow-hidden h-[600px]">
                <iframe
