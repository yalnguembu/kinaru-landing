...
{
    return (
        <article className="flex gap-10 justify-between bg-white p-7 rounded-xl">
            <Image src={post.image_url} alt={post.title} width={250} height={50}/>
            ...
            <div className="flex flex-col w-full gap-3">
                <ul className="list-disc flex flex-col gap-1 ml-5">
                    <li>{(new Date(post.meta.created_at)).toUTCString()}</li>
